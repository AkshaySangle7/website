...
<input type="textbox" name="amt" id="amt" value="<?php if(!empty($total_price)){ echo number_format($total_price);} else{ echo "0";}?>" readonly style="height: 20px;"/><br/><br/>
 ...
 <script>
	function yes(){ 
	 <?php
		...
		/*$sql = "INSERT INTO payment (order_id, name, amount, payment_status,added_on) VALUES ('$order_id','$customer_name','$total_price','pay on delivery','$added_on')";
		...
		foreach ($_SESSION["cart_item"] as $item){
            ...
            $sql2 = "INSERT INTO orders (order_id,customer_name,order_details,total_bill) VALUES ('$order_id','$customer_name','$order_details','$amt')";
